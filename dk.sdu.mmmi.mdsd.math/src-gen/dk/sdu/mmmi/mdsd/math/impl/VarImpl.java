 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.VarImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarImpl extends ExpressionImpl implements Var
{
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MathPackage.VAR__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(MathExp newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MathPackage.VAR__REF, oldRef, ref));
  }
